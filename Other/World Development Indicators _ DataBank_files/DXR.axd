...
{
    background-image: url('/DXR.axd?r=1_75-bVnjl');
...
/* ASPxCololrEdit */
.dxcpColorAreaSys {
	background-image: url('/DXR.axd?r=1_14-bVnjl');
	position: relative;
	width: 290px;
	height: 240px;
	overflow: hidden;
...
.dxcpHueAreaSys {
	background-image: url('/DXR.axd?r=1_16-bVnjl');
	position: relative;
	margin-left: 10px;
    width: 20px;
    height: 240px;
...
.dxcpColorPointerSys {
	background-image: url('/DXR.axd?r=1_15-bVnjl');
	position: absolute;
	width: 11px;
	height: 11px;
}
.dxcpHuePointerSys {
	background-image: url('/DXR.axd?r=1_17-bVnjl');
	position: absolute;
	width: 35px;
	height: 9px;
	left: -7px;
...
{
	background-image: url('/DXR.axd?r=1_60-bVnjl');
}
...
.dxpLite .dxp-dropDownButton
{
    ...
    background: #e6e6e6 url('/DXR.axd?r=1_68-bVnjl') repeat-x top;
    
}
.dxpLite .dxp-hoverDropDownButton
{
    border: 1px solid #606060;
    background: #f2f2f2 url('/DXR.axd?r=1_69-bVnjl') repeat-x top;
}
...
{
	background: #E8E7E8 url('/DXR.axd?r=1_76-bVnjl') repeat-x;
	border: 1px solid #7F7F7F;
	cursor: pointer;
	padding: 5px;
	font-size: 0;
...
{
	background: #F4F4F4 url('/DXR.axd?r=1_78-bVnjl') repeat-x;
}
...
.dxtcLite > .dxtc-stripContainer .dxtc-sbDisabled
{
	cursor: default;
	border-color: #C3C3C3;
	background: #E6E7E8 url('/DXR.axd?r=1_77-bVnjl') repeat-x;
}
...
.dxucBrowseButton
{
	padding: 3px 8px 4px;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_83-bVnjl') repeat-x top;
}
...
{
	border: 1px solid #606060;
	background: #F2F2F2 url('/DXR.axd?r=1_84-bVnjl') repeat-x top;
}
...
{
	background: url('/DXR.axd?r=1_74-bVnjl') repeat;
	font-size: 0px;
	line-height: 0px;
}
.dxsplLCC
...
.dxtvControl .dxtv-ln
{
	background: url('/DXR.axd?r=1_81-bVnjl') repeat-y;
	vertical-align: top;
}
...
.dxtvControl .dxtv-elb
{
	background: url('/DXR.axd?r=1_79-bVnjl') no-repeat;
}
...
.dxtvControl.dxtvRtl .dxtv-elb
{
	background-image: url('/DXR.axd?r=1_80-bVnjl');
}
...
{
	width: 3px;
	background: url('/DXR.axd?r=1_48-bVnjl') repeat-y right;
	border-width: 0px;
}
...
{
    background-image: url('/DXR.axd?r=1_58-bVnjl');
    background-repeat: no-repeat;
...
.dxigItem
{
    background-repeat: no-repeat;
    background-position:center center;
    background-image: url('/DXR.axd?r=1_54-bVnjl');
}
.dxigItem a
{
    outline: 0;
...
{
    width: 43px;
    background: url('/DXR.axd?r=1_55-bVnjl') repeat-y;
}
.dxigControl .dxig-bottomPanel .dxis-nbBottom > .dxis-prevBtnHorWrapper
{
...
.dxrControl .dxtcLite.dxtc-top .dxr-fileTab {
    background: #e5e5e5 url('/DXR.axd?r=1_72-bVnjl') repeat-x;
    border-color: #a8a8a8;
    border-left-width: 1px;
    border-right-width: 1px;
}
.dxrControl .dxtcLite.dxtc-top .dxtc-tabHover.dxr-fileTab {
    background: #E8E7E8 url('/DXR.axd?r=1_73-bVnjl') repeat-x;
    border-color: #a8a8a8;
}
